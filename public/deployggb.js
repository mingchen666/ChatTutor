  ...
  var GGBApplet = function () {
    ...
    var setDefaultHTML5CodebaseForVersion = function (version, offline) {
      ...
      if (index > 0) {
        ...
        codebase = 'https://www.geogebra.org/apps/5.2.905.1/'
      }
  ...
  GGBAppletUtils.makeModule = function (name, permutation) {
    function webModule() {
      ...
      webModule.__moduleBase =
        'https://www.geogebra.org/apps/5.2.905.1/' + name + '/'
